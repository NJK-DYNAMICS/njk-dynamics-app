...
## 5.1 Layout do Repositório (Monorepo)

| Camada | Caminho | Descrição |
| :--- | :--- | :--- |
| Portal NEXUS | `apps/nexus/` | Shell HTML + links para `src/` |
| UI Dataware | `apps/dataware/` | Gerenciador de Clientes |
| Finalyze | `apps/finalyze/` | Calculadora de contratos |
| Lógica frontend | `src/pages/` | `nexus.js`, `dataware-clientes.js`, `finalyze.js` |
| Estilos | `src/styles/` | `tokens.css` + CSS por app |
| API Python | `api/dataware/` | FastAPI, Supabase, `main.py` |
